...
const apriSuGoogleMaps = {
  ...
  callback: function(e){
    let zoom = "750m";
    let url = `https://www.google.ch/maps/@${[e.latlng.lat,e.latlng.lng].join(",")},${zoom}/data=!3m1!1e3`;
...
const buildContextmenuItem = (text, callback) => ({text: text, callback: callback});
