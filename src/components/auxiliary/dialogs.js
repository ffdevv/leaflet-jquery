...
const MODAL_BUTTON_CLOSE_MARKUP = '<button type="button" class="btn btn-secondary" data-dismiss="modal">Chiudi</button>';
...
const uiDialog = function(title, markup, buttons, options){
  ...
  if (buttons) { buttons += MODAL_BUTTON_CLOSE_MARKUP }
    else { buttons = MODAL_BUTTON_CLOSE_MARKUP }
